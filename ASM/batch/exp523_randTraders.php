...
setLimitOper($numAgent, $agentList,1.0);
...
while ($vol <= 100) {
	...
	setVol($numAgent, $agentList,$vol/100);
	...
	$filename_prices="./results/test_vol_".$vol."_prices.csv";
	exportMysqlToCsv($query_prices, $filename_prices);
	
	$query_portfolio="SELECT * FROM quickfix.portfolio";
	$filename_portfolio="./results/test_vol_".$vol."_portfolios.csv";
	...
	$filename_agents="./results/test_vol_".$vol."_agents.csv";
