...
//$statusOrderMatch = exec("./scripts/ordermatch.sh status");
//if($statusOrderMatch == "STARTED"){}
//if($statusOrderMatch == "STOPPED"){}
//$statusMarketMaker = exec("./scripts/marketmaker.sh status");
//if($statusMarketMaker == "STARTED"){}
//if($statusMarketMaker == "STOPPED"){}
...
while ($trial <=10000) {
	...
	setBudget($numAgent, $agentList,$cash,$stock);
	...
	$filename_prices="./results/test".$trial."_prices.csv";
	exportMysqlToCsv($query_prices, $filename_prices);
	
	$query_portfolio="SELECT * FROM quickfix.portfolio";
	$filename_portfolio="./results/test".$trial."_portfolios.csv";
	...
	$filename_agents="./results/test".$trial."_agents.csv";
