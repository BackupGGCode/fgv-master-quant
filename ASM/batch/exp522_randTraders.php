...
while ($trial <= 100) {
	...
	setLimitOper($numAgent, $agentList,$trial/100);
	...
	$filename_prices="./results/test_limitOper_".$trial."_prices.csv";
	exportMysqlToCsv($query_prices, $filename_prices);
	
	$query_portfolio="SELECT * FROM quickfix.portfolio";
	$filename_portfolio="./results/test_limitOper_".$trial."_portfolios.csv";
	...
	$filename_agents="./results/test_limitOper_".$trial."_agents.csv";
